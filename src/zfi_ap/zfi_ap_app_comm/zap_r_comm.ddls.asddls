...
define root view entity ZAP_R_COMM
  ...
  association [0..*] to ZAP_C_OCR_UI     as _OCR                        on  $projection.CommUuid = _OCR.ParentUuid
  association [0..*] to ZAP_C_VAL_UI     as _Val                        on  $projection.CommUuid = _Val.ParentUuid
  ...
  association [0..1] to ZAP_I_MSG_CFG    as _CommStatusMsgConfig        on  $projection.CommStatus = _CommStatusMsgConfig.MessageNumber

  association [0..1] to ZAP_I_MSG_CFG    as _CurrentStepStatusMsgConfig on  $projection.CurrentStepStatus = _CurrentStepStatusMsgConfig.MessageNumber
...

{
  key CommUuid,
      ...
      _Appr,
      _LatestLogs,
      _CommStatusMsgConfig,
      _CurrentStepStatusMsgConfig,
      _CurrentStepVH,
      _ChannelVH,
      _CreatedUser,
      _ChangedUser
