...
define view entity ZAP_I_SCLRK_VH

  as select distinct from  zap_a_vend_cc as Vend_Cc 
  left outer join I_User as User on User.UserID = Vend_Cc.supvsor_clerk_btp_uname
{
      @Search.defaultSearchElement: true
      @Search.fuzzinessThreshold: 1.0
      @ObjectModel.text.element: ['Description']
  key Vend_Cc.supvsor_clerk as SupvsorClerk,
      @Semantics.text: true
      @Search.defaultSearchElement: true
